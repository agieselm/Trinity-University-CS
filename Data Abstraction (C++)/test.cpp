...
bool checkRemove(BSTMap<int,string> bst,vector<int> &v,BSTMap<int,string> &orig,int remKey) {
   ...
   cout<< "past first traversal after remove\n";
   if (bst.erase(remKey) == 1) { std::cout << "WORKINGI\n";} 
