...
int main() {
   ...
   cout << "If 0 false, 1 true" << a.empty() << '\n';

   cout << '\n';

   cout << "insert test on HashMap A.." << '\n';

   a.insert(make_pair(0, 9));
   a.insert(make_pair(1, 8));
   a.insert(make_pair(2, 7));
   a.insert(make_pair(3, 6));
   a.insert(make_pair(4, 5));
   a.insert(make_pair(5, 4));
   a.insert(make_pair(6, 3));
   a.insert(make_pair(7, 2));
   a.insert(make_pair(8, 1));
   a.insert(make_pair(9, 0));
...
int doTests() {
  ...
  for(int i=100; i<110; ++i) {
        ...
        f2iter++;
        auto iter = hash2.erase(hash2.find(2));
        if(hash2.count(2)!=0) {
